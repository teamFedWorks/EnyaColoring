...
class ModelImageVisualizer:
    ...
    def get_transformed_image(self, image: Image.Image, render_factor: int = None, post_process: bool = True, watermarked: bool = True) -> Image:
        self._clean_mem()
        
        # If input is a file path, open it; otherwise, assume it's already a PIL Image
        orig_image = image 
